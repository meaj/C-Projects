/*  Scheduler tester
 *      This program will test each scheduler with all values from "0, 0, 0, 0, 0, 0, 0" to "60, 60, 60, 60, 60, 60, 60"
 */
#include <stdio.h>
#include <string.h>
#define MAX_INDEX 10
